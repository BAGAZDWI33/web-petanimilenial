            ...
            <div class="container">
                <div class="row gx-5">
                    ...
                    <div class="col-lg-6 pb-5">
                        ...
                        <p class="mb-4">Solusi bagi anda sebagai petani zaman moderen untuk memenuhi
                            kebutuhan pertanian yang mengunakan teknologi terkini yaitu pemanfaatan IOT dan Drone
                            sebagai alat pertanian terkini untuk menunjangan berbagai hal baru dan hasil produk yang
                            berkualitas tinggi</p>
                        <div class="row gx-5 gy-4">
                            <div class="col-sm-6">
                                <i class="fa fa-seedling display-1 text-secondary"></i>
                                <h4>100% Organic</h4>
                                <p class="mb-0">Dengan penanaman yang higienis dan fresh berstandar internasional</p>
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-award display-1 text-secondary"></i>
                                <h4>Award Winning</h4>
                                <p class="mb-0">Kami memiliki penghargaan dan sertifikasi nasional maupun internasional
                                </p>
                            </div>
                        </div>
                    </div>
