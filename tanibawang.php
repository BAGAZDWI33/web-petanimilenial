                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <div class="row g-5 mb-5">
                            <div class="col-md-6">
                                <img class="img-fluid w-100" src="img/tanibawang.jpg" alt="">
                            </div>
                            <div class="col-md-6">
                                <img class="img-fluid w-100" src="img/tanibawang2.jpg" alt="">
                            </div>
                        </div>
                        ...
                        <p style="text-align: justify; text-indent: 0.5in;">
                            ...
                            individu dari mulsa signifikan pada pengurangan intensitas
                            serangan S. exigua dan meningkatkan hasil bawang merah.
                            Mulsa jerami padi mengurangi intensitas serangan S. exigua
                            sebesar 20.83%, sedangkan mulsa kakao meningkatkan hasil
                            sebesar 47.61% dibandingkan dengan perlakuan kontrol
                            (Valentino dan Thaha, 2019). Penggunaan ekstrak biji
                            dan daun tanaman Mimba mampu menekan laju serangan
                            Liriomyza spp. hingga 3.04% dan meningkatkan produktivitas
                            BMVLP (Arfan et al., 2019). Hasil penelitian Agustin et al.,
                            (2016) menunjukkan bahwa, ekstrak daun mimba konsentrasi
                        ...
                        <p style="text-align: justify; text-indent: 0.5in;"> Penggunaan jamur Beauveria bassiana untuk mengendalikan
                            ...
                            jamur Beuveria bassiana secara signifikan mempengaruhi
                            intensitas serangan S.exigua, selama 4-8 minggu setelah tanam
                            (MST). Perlakuan B. Bassiana 10 g L-1 air dengan interval
                            penyemprotan 5 hari sekali, mampu mengendalikan serangan S.exigua dengan hasil terendah
                            (1-2%) serta menghasilkan bobot umbi
                            tertinggi (143.82 g rumpun-1) atau 3.60 ton ha-1 dibandingkan dengan
                            semua perlakuan lainnya (Roziyanto et al., 2013). Aplikasi Biverin
                            dengan bahan aktif Beauveria bassiana, dengan konsentrasi 6 ml L-1
                            air yang diaplikasikan setiap 5 hari, lebih efektif menekan kepadatan
                            dan tingkat serangan populasi larva S. exiqua. Disamping itu, dapat
                            menghasilkan bawang merah sebesar 8.53 ton ha-1 (Abd. Razak et
                            al., 2016). Aplikasi biokultur diperkaya bioinsektisida B. bassiana
                            dapat mengendalikan hama S. exigua pada pertanaman BMVLP.
                            Aplikasi biokultur diperkaya bioinsektisida B. bassiana sebesar 10
                            g L-1 air dapat menurunkan serangan hama ulat bawang S. exigua
                            sebesar 10% dan meningkatkan sebesar 3.96 ton ha-1 dibandingkan
                            dengan kontrol (Nasir et al., 2017). </p>
                        ...
                        <p style="text-align: justify; text-indent: 0.5in;">Penelitian dengan metode isolasi dan identifikasi
                            ...
                            efektif dalam menekan pertumbuhan jamur A. porri EII. Cif.
                        ...
                        <p style="text-align: justify; text-indent: 0.5in;"> Salah satu teknologi untuk memperbaiki hasil dan kualitas
                            ...
                            5.0 g tanaman-1 atau dengan aplikasi pupuk hayati mikoriza dosis 2.5
                            5.0 g tanaman-1 (Sumiati dan Gunawan, 2007). Cendawan mikoriza
                            arbuskula (CMA) diketahui meningkatkan pertumbuhan
                            tanaman bawang merah (Allium cepa L. kelompok
                            aggregatum) dan membantu meningkatkan ketahanan tanam-
                            an terhadap gangguan penyakit. Intensitas dan laju
                            perkembangan penyakit bercak ungu pada tanaman bawang
                            merah yang diinokulasi CMA lebih rendah dibandingkan
                            dengan kontrol maupun tanaman yang diberi perlakuan
                            fungisida kimia (Sari et al., 2017).</p>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="email" class="form-control bg-white border-0"
                                        placeholder="Alamat Email" style="height: 55px;" name="email">
                                </div>
                                <div class="col-12">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start bg-primary p-4">
                            <a class="fs-5 fw-bold text-white mb-2" href="#"><i
                                    class="bi bi-arrow-right me-2"></i>Pertanian Padi</a>
                            <a class="fs-5 fw-bold text-white mb-2" href="#"><i
                                    class="bi bi-arrow-right me-2"></i>Palawija</a>
                            <a class="fs-5 fw-bold text-white mb-2" href="#"><i
                                    class="bi bi-arrow-right me-2"></i>Budidaya Anggur</a>
                            <a class="fs-5 fw-bold text-white mb-2" href="#"><i
                                    class="bi bi-arrow-right me-2"></i>Penyewaan Alat Pertanian</a>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-primary p-4">
                            <div class="d-flex overflow-hidden mb-3">
                                ...
                                <a href=""
                                    class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Menjelajahi
                            ...
                            <div class="d-flex overflow-hidden mb-3">
                                ...
                                <a href=""
                                    class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Panen
                            ...
                            <div class="d-flex overflow-hidden mb-3">
                                <img class="img-fluid flex-shrink-0" src="img/blog-1.jpg" style="width: 75px;" alt="">
                                <a href=""
                                    class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Penanaman
                            ...
                            <div class="d-flex overflow-hidden">
                                <img class="img-fluid flex-shrink-0" src="img/blog-2.jpg" style="width: 75px;" alt="">
                                <a href=""
                                    class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Penegcekan
